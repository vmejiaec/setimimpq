...
public partial class PLA_Pla_Lote_GvFv : PaginaBase
{
    // Nombre del contenedor
    protected override string Contenedor
    {
        get { return "PLA_Pla_Lote_GvFv"; }
    }
    ...
    protected void Filtrar()
    {
        ...
        {
            case "Todos":
                gvPla_Lote.DataSourceID = odsgvPla_Lote.ID;
                break;
			}
        gvPla_Lote.DataBind();
        // Si existe algún error en el FormView lo borra
        lbFvMsgErrorPla_Lote.Text = ":";
        lbFvMsgInfoPla_Lote.Text = "> Filtrado";
    }

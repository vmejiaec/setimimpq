...
CREATE PROCEDURE [dbo].[Seg_Rol_Menu_ByRol]
(
...
Order by
	dbo._Ver_Etiqueta_Nombre1(@p_Ver_Version_Id, dbo._Dic_Pantalla_Dic_Rotulo_Id(Dic_Pantalla_Id)),
	Grupo,
    dbo._Ver_Etiqueta_Nombre1(@p_Ver_Version_Id, dbo._Dic_Con_Elemento_Dic_Rotulo_Id(Dic_Con_Elemento_Id))
   

--select dbo._Ver_Etiqueta_Nombre1 ('1', dbo._Dic_Pantalla_Dic_Rotulo_Id(Dic_Pantalla_Id))  from Seg_Rol_Menu
--
--select dbo._Ver_Etiqueta_Nombre1 ('1', dbo._Dic_Con_Elemento_Dic_Rotulo_Id(Dic_Con_Elemento_Id)) from Seg_Rol_Menu
--
--
--
--

...
CREATE PROCEDURE [dbo].[Seg_Rol_Elemento_ByRolLikeEtiqueta]
(
...
and dbo._Ver_Etiqueta_Nombre1(@p_Ver_Version_Id, dbo._Dic_Con_Elemento_Dic_Rotulo_Id(Dic_Con_Elemento_Id)) like @p_nombre 

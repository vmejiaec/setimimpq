...
CREATE PROCEDURE [dbo].[Seg_Rol_Elemento_ByLikeNombre]
(
...
AND upper(dbo._Dic_Contenedor_Nombre (dbo._Dic_Con_Elemento_Dic_Contenedor_Id (Dic_Con_Elemento_Id))) like upper(@p_Nombre) 

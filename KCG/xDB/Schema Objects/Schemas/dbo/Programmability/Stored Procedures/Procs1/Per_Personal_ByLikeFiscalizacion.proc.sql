...
CREATE PROCEDURE [dbo].[Per_Personal_ByLikeFiscalizacion]
(
...
FROM Per_Personal
WHERE 	dbo.Par_Razon_Social_Nombre (Par_Razon_Social_Id) like @p_Nombre
And ltrim(rtrim(Fiscalizacion)) = 'S'
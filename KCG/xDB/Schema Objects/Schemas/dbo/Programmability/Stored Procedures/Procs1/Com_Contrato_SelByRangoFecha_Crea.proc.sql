CREATE PROCEDURE dbo.Com_Contrato_SelByRangoFecha_Crea
(
	@p_Fecha_Crea_Ini smalldatetime,
	@p_Fecha_Crea_Fin smalldatetime
)
AS
--	SET NOCOUNT ON;
SELECT        
  ...
  Fecha_Juridico
FROM	Com_Contrato
where Fecha_Crea between @p_Fecha_Crea_Ini and @p_Fecha_Crea_Fin
order by Fecha_Crea, Pla_Tarea_Codigo

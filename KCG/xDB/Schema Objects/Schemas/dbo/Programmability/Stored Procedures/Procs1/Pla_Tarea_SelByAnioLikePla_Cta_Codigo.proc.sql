...
CREATE PROCEDURE [dbo].[Pla_Tarea_SelByAnioLikePla_Cta_Codigo]
( @p_Anio varchar(4),
...
and UPPER((select c.Codigo from Pla_Cta c where c.Id = t.Pla_Cta_Id)) like UPPER(@p_Pla_Cta_Codigo)+ '%'

CREATE PROCEDURE [dbo].[Apu_Rubro_Mano_Obra_ByProyectoRubro]
(
...
Where Apu_Rubro_Mano_Obra.Apu_Rubro_id = @p_Apu_Rubro_id
and Apu_Mano_Obra_Id not in 
  (Select Apu_Mano_Obra_Id
   From Apu_Proyecto_Mano_Obra	
   Where Apu_Proyecto_Mano_Obra.Apu_Proyecto_Id = @p_Apu_Proyecto_Id)

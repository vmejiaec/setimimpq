...
CREATE PROCEDURE [dbo].[Apu_Proyecto_Rubro_Material_ByProyecto]
(
...
SELECT     
    ...
    dbo._Apu_Proyecto_Rubro_Material_Costo_Diario_X_Cantidad          (id,@p_apu_Proyecto_Id) costo_total,
    dbo._Apu_Proyecto_Rubro_Material_Transporte_Costo_Diario_X_Cantidad (id,@p_apu_Proyecto_Id) costo_total_transporte,

CREATE PROCEDURE [dbo].[Apu_Rubro_Material_ByProyectoRubro]
(
...
Where Apu_Rubro_Material.Apu_rubro_id = @p_apu_rubro_id
and Apu_Material_Id not in 
  (Select Apu_Material_Id
   From Apu_Proyecto_Material	
   Where Apu_Proyecto_Material.Apu_Proyecto_Id = @p_Apu_Proyecto_Id)

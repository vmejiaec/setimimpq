...
CREATE PROCEDURE [dbo].[Apu_Proyecto_Rubro_Material_Select]
(
...
SELECT     
    ...
    dbo._Apu_Proyecto_Rubro_Material_Costo_Diario_X_Cantidad          (id,dbo._Apu_Proyecto_Rubro_Material_Apu_Proyecto_Id (Id)) costo_total,
    dbo._Apu_Proyecto_Rubro_Material_Transporte_Costo_diario_X_Cantidad (id,dbo._Apu_Proyecto_Rubro_Material_Apu_Proyecto_Id (Id)) costo_total_transporte,

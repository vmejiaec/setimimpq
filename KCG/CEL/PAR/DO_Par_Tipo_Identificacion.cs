    ...
    public class DO_Par_Tipo_Identificacion
    {
        ...
        public List<Par_Tipo_Identificacion> Get(Scope s)
        {
            ...
            if (s != null)
            {
                ...
                llamada = "Nombre del Método Utilizado: Get " + "Parametros  Enviados en el Método: s " +
                          " Nombre del Store Procedure: " + " Par_Tipo_Identificacion_Get " + " Número de Registros: " +
                          numeroRegistros;
                //Carga en la lista
        ...
        public List<Par_Tipo_Identificacion> GetByLikeNombre(Scope s, string Nombre)
        {
            ...
            if (s != null)
            {
                ...
                llamada = "Nombre del Método Utilizado: " + " GetByLikeNombre" + " Parametros  Enviados en el Método: " +
                          ...
                          "dbo.Par_Tipo_Identificacion_ByLikeNombre " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Parametros.Par_Tipo_IdentificacionRow fila in tabla)
                    lista.Add(new Par_Tipo_Identificacion(
                        fila.Id,
        ...
        public int Delete(Scope s, Par_Tipo_Identificacion o)
        {
            ...
            catch (SqlException e)
            {
                ...
                {
                    eCaso = new Exception("Par Razón Social");

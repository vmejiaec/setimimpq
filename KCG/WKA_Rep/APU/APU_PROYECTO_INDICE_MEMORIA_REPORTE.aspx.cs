...
namespace WKA_Rep
{
    public partial class APU_PROYECTO_INDICE_MEMORIA_REPORTE : KPaginaReporte
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            decimal Apu_Proyecto_Costo_Material = 0;
            ...
            else
            {
                ...
                if (proyectos.Rows.Count > 0)
                {
                    ...
                    Apu_Proyecto_Costo_Material = Convert.ToDecimal((proyectos.Rows[0])["Costo_Material"]);
                    lblMensaje.Text = "";
                }
                else
                {
            ...
            parametros[4] = new ReportParameter("pr_dat_proyecto_costo_material", Convert.ToString(Apu_Proyecto_Costo_Material));
            parametros[5] = new ReportParameter("pr_dat_empresa_imagen",ObtenerUrlCompleta(Empresa.Imagen));

            rptMemoriaTecnica.LocalReport.SetParameters(parametros);
            rptMemoriaTecnica.LocalReport.Refresh();
        }
    }
}

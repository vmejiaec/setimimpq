<%@ Page Language="C#" 
         ...
         CodeBehind="APU_PROYECTO_RUBRO_MATERIAL_REPORTE.aspx.cs" 
         Inherits="WKA_Rep.APU_PROYECTO_RUBRO_MATERIAL_REPORTE" 
         Culture="auto" 
    ...
    <table>
            ...
            <tr>
                <td style="width: 100px; height: 21px;">
                    ...
                    <rsweb:ReportViewer id="RptProyectoMaterial" runat="server" 
                                        Font-Names="Verdana"
                                        Font-Size="8pt" 
                                        Height="29.7cm" 
                                        style="position: relative" 
                                        Width="21cm">
                    <localreport reportpath="APU/APU_PROYECTO_RUBRO_MATERIAL_REPORTE.rdlc" EnableExternalImages="true">
                        <DataSources>
                            <rsweb:ReportDataSource Name="Apu_Proyecto_Rubro_Material" 
                                                    DataSourceId="odsDatosMaterial">
                            </rsweb:ReportDataSource>
                        </DataSources>
                    </localreport>
                    </rsweb:ReportViewer>
                        <asp:ObjectDataSource ID="odsDatosMaterial" runat="server" 
                                              OldValuesParameterFormatString="original_{0}"
                                              SelectMethod="GetByProyecto" 
                                              TypeName="REL.APU.RO_Apu_Proyecto_Rubro_Material">
                              <SelectParameters>

<%@ Page Language="C#" 
         ...
         CodeBehind="APU_PROYECTO_INDICE_REPORTE.aspx.cs" 
         Inherits="WKA_Rep.APU_PROYECTO_INDICE_REPORTE"
         Culture="auto" 
    ...
    <table>
            ...
            <tr>
                <td style="width: 100px; height: 21px;">
                    <rsweb:ReportViewer id="rptProyectoIndice" runat="server" 
                                        Height="29.7cm" 
                                        style="position: relative"
                                        Width="21cm" 
                                        Font-Names="Verdana" 
                                        Font-Size="8pt">
                        <localreport reportpath="APU/APU_PROYECTO_INDICE_REPORTE.rdlc" EnableExternalImages="true"><DataSources>
<rsweb:ReportDataSource Name="Apu_Proyecto_Indice" DataSourceId="ObjectDataSource1"></rsweb:ReportDataSource>
<rsweb:ReportDataSource Name="Apu_Proyecto" DataSourceId="ObjectDataSource1"></rsweb:ReportDataSource>
</DataSources>
</localreport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
                                                               ...
                                                               SelectMethod="Get" 
                                                               TypeName="REL.APU.RO_Apu_Proyecto_Indice">
                            <SelectParameters>

...
namespace AEL.APU
{
public class Apu_Titulo: Entidad
{
// Atributos
...
public Apu_Titulo()
{
 ...
 public Apu_Titulo(String _Id,String _Codigo, String _Nombre,String _Estado,String _Int_Empresa_Id, String _Int_empresa_Codigo, String _Int_Empresa_nombre, String _Estado_Nombre )
{
this.Id=_Id;
this.Codigo=_Codigo;  
this.Nombre=_Nombre;

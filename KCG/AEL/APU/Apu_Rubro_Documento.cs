...
namespace AEL.APU
{
public class Apu_Rubro_Documento: Entidad
{
// Atributos
...
// Constructor
public Apu_Rubro_Documento()
{
}
 public Apu_Rubro_Documento(String _Id,String _Codigo, String _Nombre,String _Estado,String _Apu_Rubro_Id, String _Ruta, String _Descripcion, String _Apu_Rubro_Codigo, String _Apu_Rubro_Nombre, String _Apu_Rubro_Unidad, String _Path_Nombre, String _Estado_Nombre )
{
this.Id=_Id;
this.Codigo=_Codigo; 
this.Nombre=_Nombre;

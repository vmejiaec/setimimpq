CREATE PROCEDURE  sp_delegar_area_responsable                                                                                                                                                                                                             
...
/*select @MENSAJE =  '  COD AREA '+ @as_cod_area+ ' area_seg ' +  @as_area_seg */
/*print  @MENSAJE*/

/* BORRAR EL REGISTRO DE LA TABLA GDASIRES Y VOLVER A INSERTAR REGISTRO(S) DE ASIGNACION DE LAS NUEVAS AREAS */
/* RESPONSABLES */
DELETE GDASIRES
WHERE GD_CODIGO_INSTITUCION = @as_cod_institucion AND
	 GD_CODIGO_SUCURSAL = @as_cod_sucursal AND   
	 ...
	 GD_NUMERO = @al_numero   AND
              GD_AREA_RESPONSABLE = @as_area_seg AND

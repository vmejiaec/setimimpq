...
CodeFile="Pla_Lote_Tipo_GvFv.aspx.cs" 
Inherits="PLA_Pla_Lote_Tipo_GvFv" %>
...
<%--Autocompletar del FormView de Pla_Lote_Tipo --%>
...
<%--[X]FIN Javascript para manegar los campos de autocompletar --%>
    ...
    <%--[O] GridView de Pla_Lote_Tipo --%>
    <asp:Panel runat="server" GroupingText="Registros">
    <asp:GridView ID="gvPla_Lote_Tipo" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="Id" AllowPaging="True" DataSourceID="odsgvPla_Lote_Tipo" 
        SelectedRowStyle-CssClass="selectedrowstyle" 
		AlternatingRowStyle-CssClass="alternatingrowstyle" 
        HeaderStyle-CssClass="headerstyle" 
		PagerStyle-CssClass="pagerstyle"
		AllowSorting="true"
            onselectedindexchanged="gvPla_Lote_Tipo_SelectedIndexChanged">
        <Columns>
            <asp:CommandField ButtonType="Button" SelectText="..." ShowSelectButton="True" />
			<asp:BoundField DataField="Id" HeaderText="Id" Visible = "false"  SortExpression="Id" />
			<asp:BoundField DataField="Codigo" HeaderText="Codigo"   SortExpression="Codigo" />
			<asp:BoundField DataField="Nombre" HeaderText="Nombre"   SortExpression="Nombre" />
			<asp:BoundField DataField="Archivo_Tipo" HeaderText="Archivo_Tipo"   SortExpression="Archivo_Tipo" />
	...
	<%--[X] GridView de Pla_Lote_Tipo --%>

    <%--[O] FormView de Pla_Lote_Tipo --%>
    <asp:Panel runat="server" ID="pfvPla_Lote_Tipo" GroupingText="Crear, Editar o Borar un Registro">
    <koala:FormViewSetim ID="fvPla_Lote_Tipo" runat="server" DataSourceID="odsfvPla_Lote_Tipo" 
            oniteminserting="fvPla_Lote_Tipo_ItemInserting" 
            onitemdeleted="fvPla_Lote_Tipo_ItemDeleted" 
            oniteminserted="fvPla_Lote_Tipo_ItemInserted" 
            onitemupdated="fvPla_Lote_Tipo_ItemUpdated"
			ondatabound="fvPla_Lote_Tipo_DataBound" 
            onprerender="fvPla_Lote_Tipo_PreRender"
			onitemupdating="fvPla_Lote_Tipo_ItemUpdating"
			onitemdeleting="fvPla_Lote_Tipo_ItemDeleting"
			>
        <EditItemTemplate>
			...
			<tr >
				...
				<%--Validador--%>
                    ...
                    Text="X" Display="Dynamic" ValidationGroup="vgPla_Lote_Tipo"/>
					</td>
            </tr>
			<tr >
                <td> Nombre </td>                
			...
			<tr >
                <td> Archivo_Tipo </td>                
				<td><asp:TextBox ID="Archivo_TipoTextBox" runat="server" Text='<%# Bind("Archivo_Tipo") %>'  CssClass="txtEdit"  />
				<%--Validador--%>
                    <asp:RequiredFieldValidator ID="rqArchivo_Tipo" runat="server" 
                    ControlToValidate="Archivo_TipoTextBox"
                    ErrorMessage="El campo Archivo_Tipo es obligatorio" 
                    Text="X" Display="Dynamic" ValidationGroup="vgPla_Lote_Tipo"/>
					</td>
            </tr>
			<tr >
                <td> Clase </td>                
				<td><asp:TextBox ID="ClaseTextBox" runat="server" Text='<%# Bind("Clase") %>'  CssClass="txtEdit"  />
				<%--Validador--%>
                    <asp:RequiredFieldValidator ID="rqClase" runat="server" 
                    ControlToValidate="ClaseTextBox"
                    ErrorMessage="El campo Clase es obligatorio" 
                    Text="X" Display="Dynamic" ValidationGroup="vgPla_Lote_Tipo"/>
					</td>
            </tr>
			<tr >
                <td> Metodo </td>                
				<td><asp:TextBox ID="MetodoTextBox" runat="server" Text='<%# Bind("Metodo") %>'  CssClass="txtEdit"  />
				<%--Validador--%>
                    <asp:RequiredFieldValidator ID="rqMetodo" runat="server" 
                    ControlToValidate="MetodoTextBox"
                    ErrorMessage="El campo Metodo es obligatorio" 
                    Text="X" Display="Dynamic" ValidationGroup="vgPla_Lote_Tipo"/>
					</td>
            </tr>
			</table>
            <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" Text="Actualizar" ValidationGroup="vgPla_Lote_Tipo"/>
            &nbsp;
        ...
        <InsertItemTemplate>
            ...
            <asp:Button ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" Text="Insertar" ValidationGroup="vgPla_Lote_Tipo"/>
            &nbsp;
        ...
        <ItemTemplate>
			...
			<tr >
                <td> Archivo_Tipo </td>
				<td><asp:TextBox ID="Archivo_TipoTextBox" runat="server" Text='<%# Bind("Archivo_Tipo") %>'  ReadOnly="true"  CssClass="txtItem" /></td>
							</tr>
			<tr >
                <td> Clase </td>
				<td><asp:TextBox ID="ClaseTextBox" runat="server" Text='<%# Bind("Clase") %>'  ReadOnly="true"  CssClass="txtItem" /></td>
							</tr>
			<tr >
                <td> Metodo </td>
				<td><asp:TextBox ID="MetodoTextBox" runat="server" Text='<%# Bind("Metodo") %>'  ReadOnly="true"  CssClass="txtItem" /></td>
							</tr>
			</table>
        ...
        <asp:Label ID="lbFvMsgErrorPla_Lote_Tipo" runat="server" Text=":" CssClass="FvMensajeError"></asp:Label>
        <asp:Label ID="lbFvMsgInfoPla_Lote_Tipo" runat="server" Text=">" CssClass="FvMensajeInfo"></asp:Label>
        <asp:ValidationSummary ID="vsErrorResumen" runat="server" ValidationGroup="vgPla_Lote_Tipo"/>
    </asp:Panel>
	<%--[X] FormView de Pla_Lote_Tipo --%>
    ...
    <koala:FormViewSetim ID="fvPla_Lote" runat="server" DataSourceID="odsfvPla_Lote" 
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="vgPla_Lote"/>
    </asp:Panel>
...
<%--[O]INICIO Fuentes de datos de Pla_Lote_Tipo --%>
<div>
    <%--Fuente de datos para el GridView --%>
    <asp:ObjectDataSource ID="odsgvPla_Lote_Tipo" runat="server" 
        SelectMethod="Get" 
        SortParameterName = "sortExpression"
        TypeName="FEL.PLA.BO_Pla_Lote_Tipo">
        <SelectParameters>
            <asp:SessionParameter Name="s" SessionField="Scope" Type="Object" />
        </SelectParameters>
    </asp:ObjectDataSource>
	<%--Fuente de datos para los procesos genéricos --%>
    <asp:ObjectDataSource ID="odsgvPla_Lote_Tipo_GetById" runat="server" 
        SortParameterName = "sortExpression"
    ...
    <asp:ObjectDataSource ID="odsfvPla_Lote_Tipo" runat="server" 
        SelectMethod="GetById"         
        DeleteMethod="Delete" 
        ...
        SortParameterName = "sortExpression"
        TypeName="FEL.PLA.BO_Pla_Lote_Tipo"
        DataObjectTypeName="Pla_Lote_Tipo"
        ConflictDetection = "CompareAllValues"
        OldValuesParameterFormatString="o"
        oninserted="odsfvPla_Lote_Tipo_Inserted" 
        onupdated="odsfvPla_Lote_Tipo_Updated" 
		ondeleted="odsfvPla_Lote_Tipo_Deleted">
        <SelectParameters>
            <asp:SessionParameter Name="s" SessionField="Scope" Type="Object" />
            <asp:ControlParameter ControlID="gvPla_Lote_Tipo" Name="p_Id" PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
...
<%--[X] FIN Fuentes de datos de Pla_Lote_Tipo --%>

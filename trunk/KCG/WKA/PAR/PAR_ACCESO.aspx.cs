...
public partial class PAS_PAR_ACCESO : System.Web.UI.Page
{
    ...
    protected void Btn_Conectarse_Click(object sender, EventArgs e)
    {
        ...
        if (estaAutenticado)
        {
            ...
            //Mensaje.Text = "Usuario y contraseña correctas";
    ...
    private bool EstaAutenticado(string usuario, string contrasenia)
    {
        ...
        if (estaAutenticado)
        {
            ...
            //ObneterEmpresaSucursalPredeterminadas(listIntUsuario);
    ...
    private void ObneterEmpresaSucursalPredeterminadas()
    {
        ...
        {
            throw new Exception("No existen empresa o sucursal predeterminad");
        }
    ...
    protected void Btn_Aceptar_Click(object sender, EventArgs e)
    {
        ...
        /*ScriptManager.RegisterStartupScript(this, this.GetType(), "cerraVentana",
                                            "window.close()", true);*/



        //Response.Redirect(FormsAuthentication.GetRedirectUrl(Txt_Usuario.Text,false));
    }
    ...
    string ObtenerMensajeError(XmlNode detalleMensajeError)
    {
        ...
        switch (CodigoError)
        {
            case "COD1":
                return "Error";
                //return HttpContext.GetLocalResourceObject("~/KOALA.master", MensajeError + "RecursoKCG.Text").ToString();
        }
        return "";
    }
}

...
CodeFile="Com_Procedimiento_GvFv.aspx.cs" 
Inherits="COM_Com_Procedimiento_GvFv" %>
...
<script type="text/javascript">
	...
	$('#ctl00_ContentPlaceHolder1_fvCom_Procedimiento_Valor_MinTextBox').autoNumeric('init', { aSep: '.', aDec: ',' });
	$('#ctl00_ContentPlaceHolder1_fvCom_Procedimiento_Valor_MaxTextBox').autoNumeric('init', { aSep: '.', aDec: ',' });
	    }
</script>
...
<script type="text/javascript">
    ...
    <asp:Panel runat ="server" ID="pBuscar" GroupingText ="Buscar" DefaultButton="btFiltrar">
        ...
        <asp:DropDownList ID="ddlFiltro" runat="server" AutoPostBack="true" onselectedindexchanged="ddlFiltro_SelectedIndexChanged">
			...
			<asp:ListItem Text = "Valor" Value="Valor" ></asp:ListItem>
			</asp:DropDownList>
    </asp:Panel>
	<%--[X] Filtro--%>

    <%--[O] GridView de Com_Procedimiento --%>
    <asp:Panel runat="server" GroupingText="Registros">
    <asp:GridView ID="gvCom_Procedimiento" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="Id" AllowPaging="True" DataSourceID="odsgvCom_Procedimiento" 
        SelectedRowStyle-CssClass="selectedrowstyle" 
		AlternatingRowStyle-CssClass="alternatingrowstyle" 
        HeaderStyle-CssClass="headerstyle" 
		PagerStyle-CssClass="pagerstyle"
		AllowSorting="true"
            onselectedindexchanged="gvCom_Procedimiento_SelectedIndexChanged">
        <Columns>
	...
	<%--[X] GridView de Com_Procedimiento --%>

<%--Autocompletar del FormView de Com_Procedimiento --%>
...
<%--[X]FIN Javascript para manegar los campos de autocompletar --%>
    ...
    <%--[O] FormView de Com_Procedimiento --%>
    <asp:Panel runat="server" ID="pfvCom_Procedimiento" GroupingText="Crear, Editar o Borar un Registro">
    <koala:FormViewSetim ID="fvCom_Procedimiento" runat="server" DataSourceID="odsfvCom_Procedimiento" 
            oniteminserting="fvCom_Procedimiento_ItemInserting" 
            onitemdeleted="fvCom_Procedimiento_ItemDeleted" 
            oniteminserted="fvCom_Procedimiento_ItemInserted" 
            onitemupdated="fvCom_Procedimiento_ItemUpdated"
			ondatabound="fvCom_Procedimiento_DataBound" 
            onprerender="fvCom_Procedimiento_PreRender"
			onitemupdating="fvCom_Procedimiento_ItemUpdating"
			onitemdeleting="fvCom_Procedimiento_ItemDeleting"
			>
        <EditItemTemplate>
			...
			<tr >
				...
				<%--Validador--%>
                    ...
                    Text="X" Display="Dynamic" ValidationGroup="vgCom_Procedimiento"/>
					</td>
            </tr>
			<tr >
                <td> Tipo </td>                
				<td>
				<asp:DropDownList ID="TipoDropDownList" runat="server" DataSourceID="odsDominio_Com_Procedimiento_Tipo"  CssClass="txtEdit" 
            ...
            <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" Text="Actualizar" ValidationGroup="vgCom_Procedimiento"/>
            &nbsp;
        ...
        <InsertItemTemplate>
            ...
            <asp:Button ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" Text="Insertar" ValidationGroup="vgCom_Procedimiento"/>
            &nbsp;
        ...
        <ItemTemplate>
			...
			<tr >
                <td> Tipo </td>
				<td>
				<asp:DropDownList ID="TipoDropDownList" runat="server" DataSourceID="odsDominio_Com_Procedimiento_Tipo"  Enabled="false" CssClass="txtItemDDL" 
                        DataTextField="Nombre" 
                        DataValueField="Dominio" 
                        SelectedValue='<%# Bind("Tipo") %>'>
                </asp:DropDownList>
        ...
        <asp:Label ID="lbFvMsgErrorCom_Procedimiento" runat="server" Text=":" CssClass="FvMensajeError"></asp:Label>
        <asp:Label ID="lbFvMsgInfoCom_Procedimiento" runat="server" Text=">" CssClass="FvMensajeInfo"></asp:Label>
        <asp:ValidationSummary ID="vsErrorResumen" runat="server" ValidationGroup="vgCom_Procedimiento"/>
    </asp:Panel>
	<%--[X] FormView de Com_Procedimiento --%>
...
<div>
    ...
    <asp:ObjectDataSource ID="odsgvCom_Procedimiento_GetById" runat="server" 
        SortParameterName = "sortExpression"
    ...
    <asp:ObjectDataSource ID="odsgvCom_Procedimiento_GetByLikeNombre" runat="server" 
        SortParameterName = "sortExpression"
    ...
    <asp:ObjectDataSource ID="odsgvCom_Procedimiento_GetByLikeValor" runat="server" 
        SortParameterName = "sortExpression"
        SelectMethod="GetByLikeValor" 
        TypeName="FEL.COM.BO_Com_Procedimiento">
        <SelectParameters>
            <asp:SessionParameter Name="s" SessionField="Scope" Type="Object" />
			<asp:ControlParameter ControlID="tbFiltro" Name="p_Valor" PropertyName="Text" Type="Decimal" />
		</SelectParameters>
    </asp:ObjectDataSource>
	...
	<%--Objetos de Datos para obtener los dominios del campo Tipo de la tabla Com_Procedimiento --%>
    <asp:ObjectDataSource ID="odsDominio_Com_Procedimiento_Tipo" runat="server" 
        SortParameterName = "sortExpression" 
        SelectMethod="GetByObjetoCampo" 
        TypeName="FEL.DIC.BO_Dic_Dominio"
        EnableCaching="true"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Nombre" Name="sortExpression" Type="String" />
            <asp:SessionParameter DefaultValue="" Name="s" SessionField="Scope" Type="Object" />
            <asp:Parameter Type="String" Name="Objeto_Nombre" DefaultValue="Com_Procedimiento"  />
            <asp:Parameter Type="String" Name="Campo_Nombre"  DefaultValue="Tipo"               />
        </SelectParameters>
    </asp:ObjectDataSource>
	<%--Objetos de Datos para el FormView --%>
    <asp:ObjectDataSource ID="odsfvCom_Procedimiento" runat="server" 
        SelectMethod="GetById"         
        DeleteMethod="Delete" 
        ...
        SortParameterName = "sortExpression"
        TypeName="FEL.COM.BO_Com_Procedimiento"
        DataObjectTypeName="Com_Procedimiento"
        ConflictDetection = "CompareAllValues"
        OldValuesParameterFormatString="o"
        oninserted="odsfvCom_Procedimiento_Inserted" 
        onupdated="odsfvCom_Procedimiento_Updated" 
		ondeleted="odsfvCom_Procedimiento_Deleted">
        <SelectParameters>
            <asp:SessionParameter Name="s" SessionField="Scope" Type="Object" />
            <asp:ControlParameter ControlID="gvCom_Procedimiento" Name="p_Id" PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
...
<%--[X] FIN Fuentes de datos de Com_Procedimiento --%>
</asp:Content>

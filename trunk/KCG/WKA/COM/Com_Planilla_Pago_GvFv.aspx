...
CodeFile="Com_Planilla_Pago_GvFv.aspx.cs" 
Inherits="COM_Com_Planilla_Pago_GvFv" %>
...
<script type="text/javascript">
	...
	$('#ctl00_ContentPlaceHolder1_fvCom_Planilla_Pago_Valor_Cta_X_CobrarTextBox').autoNumeric('init', { aSep: '.', aDec: ',' });
	    }
</script>
...
<%--Autocompletar del FormView de Com_Planilla_Pago --%>
    ...
    <koala:FormViewSetim ID="fvCom_Planilla_Pago" runat="server" DataSourceID="odsfvCom_Planilla_Pago" 
        ...
        <EditItemTemplate>
			...
			<tr >
				...
				<ajax:CalendarExtender runat="server" ID="cexFecha_Pago" TargetControlID="Fecha_PagoTextBox" PopupButtonID="btcexFecha_Pago" />
				<%--Validador--%>
			...
			<tr >
				...
				<td><asp:TextBox ID="Valor_Cta_X_CobrarTextBox" runat="server" Text='<%# Bind("Valor_Cta_X_Cobrar") %>'  CssClass="txtEditValor"  />
				<%--Validador--%>
			...
			<tr >
				...
				<ajax:CalendarExtender runat="server" ID="cexFecha_Pago_Confirmada" TargetControlID="Fecha_Pago_ConfirmadaTextBox" PopupButtonID="btcexFecha_Pago_Confirmada" />
				<%--Validador--%>
        ...
        <ItemTemplate>
			...
			<tr >
                <td> Valor_Cta_X_Cobrar </td>
				<td><asp:TextBox ID="Valor_Cta_X_CobrarTextBox" runat="server" Text='<%# Bind("Valor_Cta_X_Cobrar") %>'  ReadOnly="true"  CssClass="txtItemValor" /></td>
							</tr>
			<tr >
                <td> Fecha_Pago_Confirmada </td>

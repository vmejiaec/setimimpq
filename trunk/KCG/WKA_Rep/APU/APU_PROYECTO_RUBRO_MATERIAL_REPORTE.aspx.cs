...
namespace WKA_Rep
{
    public partial class APU_PROYECTO_RUBRO_MATERIAL_REPORTE : KPaginaReporte
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RptProyectoMaterial.LocalReport.SetParameters(parametros);
            RptProyectoMaterial.LocalReport.Refresh();

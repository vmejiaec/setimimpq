<%@ Page Language="C#" 
         ...
         CodeBehind="APU_PROYECTO_RUBRO_BASICO_REPORTE.aspx.cs" 
         Inherits="WKA_Rep.APU_PROYECTO_RUBRO_BASICO_REPORTE" 
         Culture="auto" 
    ...
    <table>
                ...
                <td >
                    <table 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label 
                                    ID="lblMensaje" runat="server" Style="position: relative" 
            ...
            <tr>
                <td style="width: 100px; height: 21px;">
                    <rsweb:reportviewer id="RptProyectoRubro" runat="server" 
                                        font-names="Verdana" 
                                        font-size="8pt"
                                        height="29.7cm" 
                                        width="21cm">
                           <LocalReport ReportPath="APU/APU_PROYECTO_RUBRO_BASICO_REPORTE.rdlc" EnableExternalImages="true">
                            <DataSources>
                                <rsweb:ReportDataSource Name="Apu_Proyecto_Rubro" 
                                                        DataSourceId="odsDatosRep">
                                </rsweb:ReportDataSource>
                            </DataSources>
                           </LocalReport>
                    </rsweb:reportviewer>
                    
                    <asp:ObjectDataSource ID="odsDatosRep" runat="server" 

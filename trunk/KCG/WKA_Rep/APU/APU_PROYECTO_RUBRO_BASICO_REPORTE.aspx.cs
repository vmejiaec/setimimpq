...
namespace WKA_Rep
{
    public partial class APU_PROYECTO_RUBRO_BASICO_REPORTE : KPaginaReporte
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            RptProyectoRubro.LocalReport.SetParameters(parametros);
            RptProyectoRubro.LocalReport.Refresh();

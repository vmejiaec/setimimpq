    ...
    public class DO_Fis_Catalogo_Categoria
    {
        ...
        public List<Fis_Catalogo_Categoria> Get(Scope s)
        {
            ...
            if (s != null)
            {
                ...
                llamada = "Nombre del Método Utilizado: Get " + "Parametros  Enviados en el Método: s " + " Nombre del Store Procedure: " + " Fis_Catalogo_Categoria_Get " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
        ...
        public List<Fis_Catalogo_Categoria> GetByCodigo(Scope s, string Codigo)
        {
            ...
            if (s != null)
            {
                ...
                //Cuenta  el número  de registros de la tabla
                int numeroRegistros = tabla.Count;
                llamada = "Nombre del Método Utilizado: " + " GetByCodigo" + " Parametros  Enviados en el Método: " + "," + " s.Ver_Version_Id : " + s.Ver_Version_Id + "," + " Codigo : " + Codigo + " Nombre del Store Procedure: " + "dbo.Fis_Catalogo_Categoria_ByCodigo " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Fiscalizacion.Fis_Catalogo_CategoriaRow fila in tabla)
                    lista.Add(new Fis_Catalogo_Categoria(
        ...
        public List<Fis_Catalogo_Categoria> GetById(Scope s, string Id)
        {
            ...
            if (s != null)
            {
                ...
                //Cuenta  el número  de registros de la tabla
                int numeroRegistros = tabla.Count;
                llamada = "Nombre del Método Utilizado: " + " GetById" + " Parametros  Enviados en el Método: " + "," + " s.Ver_Version_Id : " + s.Ver_Version_Id + "," + " Id : " + Id + " Nombre del Store Procedure: " + "dbo.Fis_Catalogo_Categoria_ById " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Fiscalizacion.Fis_Catalogo_CategoriaRow fila in tabla)
                    lista.Add(new Fis_Catalogo_Categoria(

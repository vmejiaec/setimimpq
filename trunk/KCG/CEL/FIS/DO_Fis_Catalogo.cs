    ...
    public class DO_Fis_Catalogo
    {
        ...
        public List<Fis_Catalogo> Get(Scope s)
        {
            ...
            if (s != null)
            {
                ...
                llamada = "Nombre del Método Utilizado: Get " + "Parametros  Enviados en el Método: s " + " Nombre del Store Procedure: " + " Fis_Catalogo_Get " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
        ...
        public List<Fis_Catalogo> GetByCodigo(Scope s, string Codigo)
        {
            ...
            if (s != null)
            {
                ...
                //Cuenta  el número  de registros de la tabla
                int numeroRegistros = tabla.Count;
                llamada = "Nombre del Método Utilizado: " + " GetByCodigo" + " Parametros  Enviados en el Método: " + "," + " s.Ver_Version_Id : " + s.Ver_Version_Id + "," + " Codigo : " + Codigo + " Nombre del Store Procedure: " + "dbo.Fis_Catalogo_ByCodigo " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Fiscalizacion.Fis_CatalogoRow fila in tabla)
                    lista.Add(new Fis_Catalogo(
                              fila.Id,
        ...
        public List<Fis_Catalogo> GetByEmpresa(Scope s,DateTime Fecha_Creacion_Desde ,DateTime Fecha_Creacion_Hasta ,DateTime Fecha_Publicacion_Desde , DateTime Fecha_Publicacion_Hasta , string Nombre  )
        {
            ...
            if (s != null)
            {
                ...
                //Cuenta  el número  de registros de la tabla
                int numeroRegistros = tabla.Count;
                llamada = "Nombre del Método Utilizado: " + " GetByEmpresa" + " Parametros  Enviados en el Método: " + "," + " s.Ver_Version_Id : " + s.Ver_Version_Id + "," + " Int_Empresa_Id : " + s.Int_Empresa_Id + "," + " Fecha_Creacion_Desde : " + Fecha_Creacion_Desde + "," + " Fecha_Creacion_Hasta : " + Fecha_Creacion_Hasta + "," + " Fecha_Publicacion_Desde : " + Fecha_Publicacion_Desde + "," + " Fecha_Publicacion_Hasta : " + Fecha_Publicacion_Hasta + "," + " Nombre : " + Nombre + "," + " Pagina_Actual : " + s.Pagina_Actual + "," + " Numero_Registros : " + s.Numero_Registros + " Nombre del Store Procedure: " + "dbo.Fis_Catalogo_ByEmpresa " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Fiscalizacion.Fis_CatalogoRow fila in tabla)
                    lista.Add(new Fis_Catalogo(
                              fila.Id,
        ...
        public List<Fis_Catalogo> GetById(Scope s, string Id)
        {
            ...
            if (s != null)
            {
                ...
                //Cuenta  el número  de registros de la tabla
                int numeroRegistros = tabla.Count;
                llamada = "Nombre del Método Utilizado: " + " GetById" + " Parametros  Enviados en el Método: " + "," + " s.Ver_Version_Id : " + s.Ver_Version_Id + "," + " Id : " + Id + " Nombre del Store Procedure: " + "dbo.Fis_Catalogo_ById " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Fiscalizacion.Fis_CatalogoRow fila in tabla)
                    lista.Add(new Fis_Catalogo(
                              fila.Id,
        ...
        public List<Fis_Catalogo> GetByLikeNombre(Scope s, string Nombre)
        {
            ...
            if (s != null)
            {
                ...
                //Cuenta  el número  de registros de la tabla
                int numeroRegistros = tabla.Count;
                llamada = "Nombre del Método Utilizado: " + " GetByLikeNombre" + " Parametros  Enviados en el Método: " + "," + " s.Ver_Version_Id : " + s.Ver_Version_Id + "," + " Nombre : " + Nombre + " Nombre del Store Procedure: " + "dbo.Fis_Catalogo_ByLikeNombre " + " Número de Registros: " + numeroRegistros;
                //Carga en la lista
                foreach (Fiscalizacion.Fis_CatalogoRow fila in tabla)
                    lista.Add(new Fis_Catalogo(
                              fila.Id,

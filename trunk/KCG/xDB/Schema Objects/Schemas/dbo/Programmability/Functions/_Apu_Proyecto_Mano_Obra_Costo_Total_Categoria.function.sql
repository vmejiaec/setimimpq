...
CREATE FUNCTION [dbo].[_Apu_Proyecto_Mano_Obra_Costo_Total_Categoria]
(
...
select @v_total_indices = isnull( dbo._Apu_Proyecto_MO_CostTot_CatInd(@p_apu_proyecto_id , @p_apu_categoria_id ),0)

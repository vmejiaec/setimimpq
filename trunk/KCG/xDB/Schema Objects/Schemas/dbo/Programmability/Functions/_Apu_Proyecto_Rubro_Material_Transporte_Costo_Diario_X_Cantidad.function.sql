...
CREATE FUNCTION [dbo].[_Apu_Proyecto_Rubro_Material_Transporte_Costo_Diario_X_Cantidad]
(
   ...
   declare 
      ...
      set @v_Resultado = (
          Select dbo.__Multiplicar_cuatro_decimales_2(
               Cantidad, dbo._apu_proyecto_Material_Costo_Transporte1(@p_Apu_Proyecto_Id, Apu_Material_Id))

CREATE FUNCTION [dbo].[_Apu_Oferta_Cuadrilla_Coeficiente_ManoObra_1]
(
...
--
    exec @v_trabajadores =  dbo._apu_oferta_cuadrilla_numero_trabajadores1 @p_apu_oferta_id, @p_apu_mano_obra_id

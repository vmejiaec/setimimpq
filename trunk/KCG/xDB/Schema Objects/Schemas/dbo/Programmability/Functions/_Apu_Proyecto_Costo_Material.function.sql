...
-- COSTO TOTAL DEL material DE UN PROYECTO
-- COSTO UNITARIO DE TODOS LOS materialS DEL PROYECTO * CANTIDAD UTILIZADA EN TODOS LOS RUBROS
create FUNCTION [dbo].[_Apu_Proyecto_Costo_Material]
(

CREATE PROCEDURE [dbo].[Apu_Presupuesto_BySucursal]
(
...
SELECT      Id, 
			...
			/*dbo._Apu_Presupuesto_Cuadrilla_Costo_Total(Id) */ 0.00 Cuadrilla_Sumatoria,
			/*dbo._Apu_Presupuesto_Cuadrilla_Coeficiente(Id)*/ 0.00 Cuadrilla_Coeficiente_Sumatoria,
			...
			/*dbo._Apu_Proyecto_Pres_Cadena_Indice (id,Apu_Origen_Id,'%' )*/'' Cadena_Indice,
			/*dbo._Apu_Proyecto_Pres_Cadena_Cuadrilla (id,'%')*/'' Cadena_Cuadrilla,

...
CREATE PROCEDURE [dbo].[Apu_Oferta_Rubro_Equipo_ById]
(
...
SELECT     
    ...
    dbo._Apu_Oferta_Codigo ( dbo._Apu_Oferta_Rubro_Apu_Oferta_Id (Apu_Oferta_rubro_Id)) 
		--'' 
		Apu_Oferta_Codigo,
    dbo._Apu_Oferta_Nombre ( dbo._Apu_Oferta_Rubro_Apu_Oferta_Id (Apu_Oferta_rubro_Id)) 
		--'' 
		Apu_Oferta_Nombre,
--    dbo._Apu_Oferta_Etapa ( dbo._Apu_Oferta_Rubro_Apu_Oferta_Id (Apu_Oferta_rubro_Id)) 
		'' Apu_Oferta_Etapa,
    
    dbo._Apu_Oferta_Rubro_Apu_Rubro_Id (Apu_Oferta_Rubro_Id) Apu_Rubro_Id,
    dbo._Apu_Rubro_Codigo ( dbo._Apu_Oferta_Rubro_Apu_Rubro_Id (Apu_Oferta_Rubro_Id)) 
		--'' 
		Apu_Rubro_Codigo,
    dbo._Apu_Rubro_Nombre ( dbo._Apu_Oferta_Rubro_Apu_Rubro_Id (Apu_Oferta_Rubro_Id)) 
		--'' 
		Apu_Rubro_Nombre,
--    dbo._Apu_Rubro_Unidad ( dbo._Apu_Oferta_Rubro_Apu_Rubro_Id (Apu_Oferta_Rubro_Id)) 
		'' Apu_Rubro_Unidad,

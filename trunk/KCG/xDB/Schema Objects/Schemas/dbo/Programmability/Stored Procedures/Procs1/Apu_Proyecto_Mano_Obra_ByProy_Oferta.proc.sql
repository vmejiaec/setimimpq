CREATE PROCEDURE [dbo].[Apu_Proyecto_Mano_Obra_ByProy_Oferta]
(
...
and Apu_Mano_Obra_Id not in (Select Apu_Mano_Obra_Id
							 from Apu_Oferta_Mano_Obra
							 where Apu_Oferta_Id = @p_apu_oferta_Id)
--ORDER BY dbo._apu_proyecto_mano_obra_cantidad_mano_obra_x_costo (Id) DESC

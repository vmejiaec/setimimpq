CREATE PROCEDURE [dbo].[Seg_Rol_Usuario_Det_BySucursalUsuarioRol]
(
...
where seg_rol_usuario_det.int_sucursal_id = @p_int_sucursal_id
and seg_rol_usuario_det.seg_rol_usuario_id in
    (select seg_rol_usuario.id
     from seg_rol_usuario
     where seg_rol_usuario.Int_Usuario_id = @p_int_usuario_id
     and seg_rol_usuario.seg_rol_id = @p_seg_rol_id)

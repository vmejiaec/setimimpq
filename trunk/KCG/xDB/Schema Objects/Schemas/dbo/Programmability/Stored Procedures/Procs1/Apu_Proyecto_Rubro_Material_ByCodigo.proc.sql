CREATE PROCEDURE [dbo].[Apu_Proyecto_Rubro_Material_ByCodigo]
(
...
SELECT     
    ...
    dbo._Apu_Proyecto_Rubro_Material_Costo_Diario_x_Cantidad          (id,  dbo._Apu_Proyecto_Rubro_Apu_Proyecto_Id (Apu_Proyecto_rubro_Id) ) costo_total,
    dbo._Apu_Proyecto_Rubro_Material_Transporte_Costo_Diario_X_Cantidad (id ,  dbo._Apu_Proyecto_Rubro_Apu_Proyecto_Id (Apu_Proyecto_rubro_Id) ) costo_total_transporte,
